        ...
        <ul className='w-244 bg-adminpage h-auto text-white'>
          <div className='px-16 py-24 w-224 h-70'>
            <a href='#' className='relative'>
              ...
              <p className=' font-bold text-center text-17'>ADMIN PAGE</p>
            </a>
          </div>
        ...
        <div className='w-full h-full'>
          <div className='h-70 mb-24 px-16 py-8 flex justify-between'>
            <div className='text-left flex'>
              ...
              <div>
                <button className='bg-adminpage w-60 h-38 rounded-r px-12 py-6'>
          ...
          <div className='w-1670 h-1494 px-24 bg-white pt-5'>
            ...
            <div className='flex w-1628 h-41 px-16 py-8 border-t border-r border-l rounded-t-md bg-payment'>
              <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
            ...
            <div className='w-1628 h-auto px-16 py-16 border rounded-b-md'>
              <div className='mb-10 flex justify-between w-900'>
                ...
                <div className=''>
                  <a href='#' className='border px-12 py-6 rounded-full bg-xamden text-white font-bold hover:bg-red'>
                    Thêm mới
                  </a>
                </div>
              </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <th className='border border-xamden text-center'>
                      <button className='px-5 py-5 border-r hover:bg-red'>xóa</button>
