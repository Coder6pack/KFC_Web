      ...
      <div className="flex justify-center px-15 py-40">
        <div className="w-846 h-978">
            <form action="" className="w-676 relative">
                <i className="absolute left-36 top-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M18 10v-4c0-3.313-2.687-6-6-6s-6 2.687-6 6v4h-3v14h18v-14h-3zm-10 0v-4c0-2.206 1.794-4 4-4s4 1.794 4 4v4h-8z"/></svg></i>
                <h1 className="text-center text-32 font-bold">THÔNG TIN ĐẶT HÀNG</h1>
                    <div>
                        <div className="relative w-676 h-87 mb-15 px-15 py-15 border-payment bg-payment">
                            <a href="#" className="absolute right-0 text-14 font-bold">Thay đổi</a>
                    ...
                    <div className="w-676 h-136 mb-15 px-15 py-15 border-payment bg-payment">
                        ...
                        <button className="w-646 h-54 text-left border rounded-xl bg-black text-white pl-10">Thanh toán bằng ATM/VISA/Master và Ví ZaloPay</button>
                    </div>
