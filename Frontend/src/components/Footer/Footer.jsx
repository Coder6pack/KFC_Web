            ...
            <div className="flex flex-nowrap justify-between color bg-denthui text-white pt-120 pb-85 px-152 w-full">
                <div className="">
                    <div className="flex flex-col ">
                        <div  className="mb-30 "><img src="https://i.pinimg.com/originals/35/7d/b1/357db15b9f94e58e5783d8e2313604df.png" className="w-50" alt="" /></div>
                ...
                <div className="flex flex-nowrap w-330 gap-120 text-16 not-italic">
                    <ul className="">
                        ...
                        <li className="font-normal mb-20">
                        Home
                        </li>
                        <li className="font-normal mb-20">
                        Home
